...
public class SoldierNameGeneratorWrapper : ISoldierNameGenerator {

    SoldierNameGenerator nameGenerator;

    public SoldierNameGeneratorWrapper(SoldierNameGenerator nameGenerator) {
